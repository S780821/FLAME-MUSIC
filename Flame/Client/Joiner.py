...
ASSIDS = []
from Flame.main import bot as app
from Flame.Client.assistant import get_assistant_details
from Flame.main import random_assistant 
from Flame.Database.clientdb import getassistant, save_assistant
