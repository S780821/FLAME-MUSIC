...
from Flame.queues import QUEUE, add_to_queue, get_queue, clear_queue

from Flame.main import call_py, bot as Flame, Test
...
async def vcraid(_, e: Message):
    ...
    if inp:
        Flame = await e.reply_text("**Starting Raid**")
